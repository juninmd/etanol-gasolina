        ...
        <View style={styles.container}>
                ...
                scannedStation && (
                    <Animated.View style={[styles.arTag, {opacity: fadeAnim}]}>
                        ...
                        <Card style={styles.tagCard}>
                            <Text category="s1" style={{fontWeight: 'bold', color: '#3366FF'}}>{scannedStation.name}</Text>
                            <View style={styles.priceRow}>
                                <Text category="c1" appearance="hint">Gasolina:</Text>
                                <Text category="s2" status="danger">R$ {scannedStation.priceGas.toFixed(2)}</Text>
                            </View>
                            <View style={styles.priceRow}>
                                <Text category="c1" appearance="hint">Etanol:</Text>
                                <Text category="s2" status="success">R$ {scannedStation.priceEthanol.toFixed(2)}</Text>
                            </View>
                        </Card>
                    </Animated.View>
                )
          ...
          <View style={styles.footer}>
             <Text style={styles.instructionText}>
                {isScanning ? 'Aponte para um posto de combustível...' : 'Posto identificado!'}
             </Text>
             <Button appearance="ghost" status="control" onPress={onClose} style={{marginTop: 10}}>
                Sair do Modo AR
             </Button>
          </View>
        </View>
